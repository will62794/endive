---- MODULE AbstractStaticRaft_Apalache ----
\*
...
\* CommitEntryType == [ entry : Int \X Int, term : Int ]
...
InvStrengthened_Test ==
    /\ LeaderCompleteness

InvStrengthened_Constraint_Test == StateConstraint => InvStrengthened_Test
IndCand_Test ==
    /\ TypeOK
    /\ InvStrengthened_Test
