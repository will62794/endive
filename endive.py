    ...
    def eliminate_ctis(self, orig_k_ctis, num_invs, roundi, subroundi=None, preds=None, preds_alt=[], 
        ...
        while iteration <= self.num_iters:
            ...
            if iteration==5:
                ...
                # Start working in some larger candidates as well.
            ...
            if self.use_cpp_invgen:
                ...
                if enable_cti_quick_pre_checks:
                    ...
                    if num_remaining_uneliminated < 0.35 * len(orig_k_ctis) or num_remaining_uneliminated < CTI_PRE_CHECK_THRESHOLD:
                        start = time.time()
                        invs = sorted(list(invs))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_duration_secs_per_round', help='Max number of seconds to spend on each iteration.', type=int, default=30000)
