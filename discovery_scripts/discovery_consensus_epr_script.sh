...
srun python3 endive.py --spec benchmarks/$specname \
    --seed $seed --num_simulate_traces 50000 --tlc_workers 28 \
    --debug --target_sample_time_limit_ms 10000 --target_sample_states 50000 \
    --opt_quant_minimize --k_cti_induction_depth 1 --override_num_cti_workers 10 \
    --cti_elimination_workers 8 \
    --ninvs 40000 --max_num_ctis_per_round 2000 \
