...
srun python3 endive.py --spec benchmarks/Hermes \
    ...
    --auto_lemma_action_decomposition --save_dot --max_num_conjuncts_per_round 8 --niters 4 --override_num_cti_workers 5 \
    --enable_partitioned_state_caching --include_existing_conjuncts --proof_tree_mode \
    --nrounds 45 \
    --action_filter "HRcvValAction,HSendValsAction,HWriteAction,HRcvInvAction,HCoordWriteReplayAction,NodeFailureAction,HFollowerWriteReplayAction,HReadAction,HRcvAckAction,HRcvInvNewerAction"
